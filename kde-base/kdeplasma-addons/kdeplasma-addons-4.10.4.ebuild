...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdeplasma-addons/kdeplasma-addons-4.10.4.ebuild,v 1.1 2013/06/04 18:21:48 johu Exp $
...
EPATCH_OPTS="-p1"
epatch "${FILESDIR}/${PN}-nogrouping.patch"
}
src_configure() {
	mycmakeargs=(
